(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_taborder("1");
            obj.set_text("TEXT(\"sample.personalization.widget\",\"Widget Menu\")");
            ...
            obj.set_taborder("3");
            obj.set_text("TEXT(\"sample.personalization.add\",\"Add\")");
            ...
            obj.set_taborder("4");
            obj.set_text("TEXT(\"sample.personalization.init\",\"Init\")");
            obj.set_cssclass("btn_WF_basic02");
            ...
            obj.set_taborder("5");
            obj.set_text("TEXT(\"sample.personalization.save\",\"Save\")");
            obj.set_cssclass("btn_WF_basic02");
        ...
        this.form_onload = function(obj,e)
        {
        	...
        	let xmlPortInfo = nexacro.getPrivateProfile("portInfo");
        	let sCompId;
        	let nLeft, nTop, nWidth, nHeight;

        	if (xmlPortInfo) // 임시 저장된 포틀릿 위치 정보가 있을 경우
        	{
        		let portInfoDs = new Dataset();
        	...
        	let xmlDelPortInfo = nexacro.getPrivateProfile("delPortInfo");
        ...
        this.fnComBtnOnClick = function(obj,e)
        {
        	...
        	{
        		case "btnWidgetAdd" :{
        			let sTitle = this.cboWidget.value;
        		...
        		case "btnClose" :{
        			let nRow = this.dsDelPortList.addRow();
        ...
        this.form_onsize = function(obj,e)
        {
        	...
        	let nLeft = (this.Div03_01.form.getOffsetWidth() / 2) - (this.Div03_01.form.Div00.form.getOffsetWidth() / 2);

        	this.Div03_01.form.Div00.move(nLeft, 36);
        };
        ...
        this.fnMakeDragObj = function(obj)
        {
        	...
        	this.staMove.visible = true;
        };

        this.fnRemoveDragObj = function()
        {
        	this.staMove.visible = false;
        };
        ...
        {
        	let nLeft = obj.getOffsetLeft();
        	let nTop = obj.getOffsetTop() + 30;
        	let nWidth = obj.getOffsetWidth();
        	let nHeight = obj.getOffsetHeight();

        	let objTile = new Div("divTile_memo" + this.fvMemocount, nLeft, nTop, nWidth, nHeight);
        	this.addChild(objTile.name, objTile);
        	objTile.show();
        	objTile.async = false;
        	objTile.url = "sample::widgetMemo.xfdl";
        	objTile.form.btnResize.addEventHandler("ondrag", this.fnObjTile_ondrag, this);
        	objTile.form.btnResize.addEventHandler("onlbuttonup", this.fnObjTile_onlbuttonup, this);
        	objTile.form.btnMove.addEventHandler("ondrag", this.fnObjTile_ondrag, this);
        	objTile.form.btnMove.addEventHandler("onlbuttonup", this.fnObjTile_onlbuttonup, this);
