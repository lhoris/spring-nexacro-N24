    ...
    return function(path)
    {
        ...
        */
        this.gfnDrawWorkFlow = function (objGraphics, objConfig, bEditable) {
            let i, nRow, dsItems, dsLines, objNewConfig,
        ...
        */
        this.gfnDrawGraphicPath = function (objGraphics, objLine) {
            let sFrom, sTo, arrFrom, arrTo, sFromPosition, sToPosition,
        ...
        */
        this.gfnDrawGraphicsCap = function (sId, objPaths, objLine, sPosition, nX, nY) {
            //영역 색상 값
            let sFillStyle = objLine.fillstyle;

            //라인 색상 값
            let sStrokpen = objLine.strokepen;

            //화살표 width 값
            let nWidth = objLine.capwidth;

            //화살표 height 값
            let nHeight = objLine.capheight;

            //선 오브젝트 만들기
            let objCapPath = new nexacro.GraphicsPath();
            objCapPath.fillstyle = sFillStyle;
            objCapPath.strokepen = sStrokpen;
        ...
        */
        this.gfnGetPositionXY = function (objPath, sPosition) {
            let objXY = { "x": null, "y": null };
        	let objRect = objPath.getOffsetBoundRect();
