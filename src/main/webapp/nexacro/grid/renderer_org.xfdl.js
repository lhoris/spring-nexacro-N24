(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            {
                this._setFormPosition(440,1260);
            }
            ...
            obj._setContents("<ColumnInfo><Column id=\"Column0\" type=\"STRING\" size=\"256\"/><Column id=\"Column1\" type=\"STRING\" size=\"256\"/><Column id=\"Column2\" type=\"STRING\" size=\"256\"/><Column id=\"Column3\" type=\"STRING\" size=\"256\"/><Column id=\"Column4\" type=\"STRING\" size=\"256\"/><Column id=\"Column5\" type=\"BIGDECIMAL\" size=\"256\"/><Column id=\"Column6\" type=\"STRING\" size=\"256\"/><Column id=\"Column7\" type=\"STRING\" size=\"256\"/><Column id=\"Column8\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"Column0\">1</Col><Col id=\"Column1\">1</Col><Col id=\"Column2\">Code1</Col><Col id=\"Column3\">Code1,Code2</Col><Col id=\"Column4\">20230303</Col><Col id=\"Column8\">ABCDEFG&#10;HIJKLMNOP</Col><Col id=\"Column6\">1</Col><Col id=\"Column5\">1000000</Col><Col id=\"Column7\">ABC</Col></Row><Row><Col id=\"Column0\">2</Col><Col id=\"Column1\">1</Col><Col id=\"Column2\">Code2</Col><Col id=\"Column4\">20240404</Col><Col id=\"Column3\">Code2,Code3</Col><Col id=\"Column5\">2000000</Col><Col id=\"Column6\">0</Col><Col id=\"Column7\">DEF</Col><Col id=\"Column8\">ABCDEFG&#10;HIJKLMNOP</Col></Row><Row><Col id=\"Column0\">3</Col><Col id=\"Column1\">1</Col><Col id=\"Column2\">Code3</Col><Col id=\"Column4\">20250505</Col><Col id=\"Column3\">Code3,Code4</Col><Col id=\"Column5\">3000000</Col><Col id=\"Column6\">1</Col><Col id=\"Column7\">GHI</Col><Col id=\"Column8\">ABCDEFG&#10;HIJKLMNOP</Col></Row><Row><Col id=\"Column0\">4</Col><Col id=\"Column1\">1</Col><Col id=\"Column2\">Code4</Col><Col id=\"Column4\">20260606</Col><Col id=\"Column3\">Code1,Code4</Col><Col id=\"Column5\">4000000</Col><Col id=\"Column6\">0</Col><Col id=\"Column7\">JKL</Col><Col id=\"Column8\">ABCDEFG&#10;HIJKLMNOP</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsCombo", this);
            obj._setContents("<ColumnInfo><Column id=\"code\" type=\"STRING\" size=\"256\"/><Column id=\"data\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"code\">Code1</Col><Col id=\"data\">Code1</Col></Row><Row><Col id=\"code\">Code2</Col><Col id=\"data\">Code2</Col></Row><Row><Col id=\"code\">Code3</Col><Col id=\"data\">Code3</Col></Row><Row><Col id=\"code\">Code4</Col><Col id=\"data\">Code4</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsMCombo", this);
            obj._setContents("<ColumnInfo><Column id=\"code\" type=\"STRING\" size=\"256\"/><Column id=\"data\" type=\"STRING\" size=\"256\"/><Column id=\"readonly\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"code\">Code1</Col><Col id=\"data\">Code1</Col><Col id=\"readonly\">0</Col></Row><Row><Col id=\"code\">Code2</Col><Col id=\"data\">Code2</Col><Col id=\"readonly\">0</Col></Row><Row><Col id=\"data\">Code3</Col><Col id=\"code\">Code3</Col><Col id=\"readonly\">0</Col></Row><Row><Col id=\"data\">Code4</Col><Col id=\"code\">Code4</Col><Col id=\"readonly\">0</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static03","20.00","868","117","30",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            ...
            obj = new Radio("Radio00","Static03:20.00","868","225","30",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            ...
            obj = new Static("Static04","20.00","1058","102","30",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            ...
            obj = new Static("Static01_00","20","323","203","30",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            ...
            obj = new Grid("Grid001","20","Static01_00:5",null,"200","20",null,null,null,null,null,this);
            obj.set_taborder("12");
            ...
            obj.set_autoenter("select");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"80\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"90\"/><Column size=\"50\"/><Column size=\"50\"/><Column size=\"90\"/><Column size=\"90\"/></Columns><Rows><Row size=\"50\" band=\"head\"/><Row size=\"50\" band=\"head\"/><Row size=\"50\"/></Rows><Band id=\"head\"><Cell text=\"Button\" color=\"#ffffff\"/><Cell col=\"1\" text=\"CheckBox\" color=\"#ffffff\"/><Cell col=\"2\" text=\"Combo\" color=\"#ffffff\"/><Cell col=\"3\" text=\"MultiCombo\" color=\"#ffffff\"/><Cell col=\"4\" text=\"Calendar\" color=\"#ffffff\"/><Cell col=\"5\" text=\"Mask\" color=\"#ffffff\"/><Cell col=\"6\" colspan=\"2\" text=\"Radio\" color=\"#ffffff\"/><Cell col=\"8\" text=\"Edit\" color=\"#ffffff\"/><Cell col=\"9\" text=\"TextArea\" color=\"#ffffff\"/><Cell row=\"1\" text=\"Button\" displaytype=\"buttoncontrol\" edittype=\"button\"/><Cell row=\"1\" col=\"1\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell row=\"1\" col=\"2\" displaytype=\"combocontrol\" edittype=\"combo\" combodataset=\"dsCombo\" combocodecol=\"code\" combodatacol=\"data\"/><Cell row=\"1\" col=\"3\" displaytype=\"multicombocontrol\" edittype=\"multicombo\" multicombodataset=\"dsMCombo\" multicombodatacol=\"data\" multicombocodecol=\"code\"/><Cell row=\"1\" col=\"4\" displaytype=\"calendarcontrol\" edittype=\"date\" calendardateformat=\"yyyy-MM-dd\"/><Cell row=\"1\" col=\"5\" displaytype=\"maskeditcontrol\" edittype=\"mask\" maskeditformat=\"#,#.##\"/><Cell row=\"1\" col=\"6\" displaytype=\"radioitemcontrol\" edittype=\"radioitem\" text=\"1\" radioitemcodevalue=\"1\"/><Cell row=\"1\" col=\"7\" displaytype=\"radioitemcontrol\" edittype=\"radioitem\" text=\"0\"/><Cell row=\"1\" col=\"8\" displaytype=\"editcontrol\" edittype=\"text\"/><Cell row=\"1\" col=\"9\" displaytype=\"textareacontrol\" edittype=\"textarea\" textareascrolltype=\"vertical\" wordWrap=\"char\"/></Band><Band id=\"body\"><Cell text=\"bind:Column0\"/><Cell col=\"1\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:Column1\" calendardateformat=\"yyyy-MM-dd\" font=\"normal 14px/normal &quot;Noto Sans KR Regular&quot;,&quot;맑은 고딕&quot;\" calendarbuttonsize=\"23\"/><Cell col=\"2\" displaytype=\"combocontrol\" edittype=\"combo\" text=\"bind:Column2\" combodataset=\"dsCombo\" combocodecol=\"code\" combodatacol=\"data\"/><Cell col=\"3\" displaytype=\"multicombocontrol\" edittype=\"multicombo\" text=\"bind:Column3\" multicombodataset=\"dsMCombo\" multicombocodecol=\"code\" multicombodatacol=\"data\"/><Cell col=\"4\" displaytype=\"calendarcontrol\" text=\"bind:Column4\" calendardateformat=\"yyyy-MM-dd\" edittype=\"date\"/><Cell col=\"5\" calendardateformat=\"yyyy-MM-dd\" text=\"bind:Column5\" maskeditformat=\"#,#.##\" displaytype=\"mask\"/><Cell col=\"6\" displaytype=\"radioitemcontrol\" text=\"bind:Column6\" edittype=\"radioitem\" radioitemcodevalue=\"1\"/><Cell col=\"7\" displaytype=\"radioitemcontrol\" edittype=\"radioitem\" text=\"bind:Column6\" radioitemcodevalue=\"0\"/><Cell col=\"8\" text=\"bind:Column7\" radioitemcodevalue=\"0\" displaytype=\"text\"/><Cell col=\"9\" radioitemcodevalue=\"1\" border=\"\\\" text=\"bind:Column8\" displaytype=\"text\" wordWrap=\"char\" textareascrolltype=\"vertical\"/></Band></Format><Format id=\"mobile\"><Columns><Column size=\"80\"/><Column size=\"80\"/><Column size=\"100\"/><Column size=\"140\"/><Column size=\"120\"/><Column size=\"100\"/><Column size=\"50\"/><Column size=\"50\"/><Column size=\"100\"/><Column size=\"100\"/></Columns><Rows><Row size=\"50\" band=\"head\"/><Row size=\"50\" band=\"head\"/><Row size=\"50\"/></Rows><Band id=\"head\"><Cell text=\"Button\" color=\"#ffffff\"/><Cell col=\"1\" text=\"CheckBox\" color=\"#ffffff\"/><Cell col=\"2\" text=\"Combo\" color=\"#ffffff\"/><Cell col=\"3\" text=\"MultiCombo\" color=\"#ffffff\"/><Cell col=\"4\" text=\"Calendar\" color=\"#ffffff\"/><Cell col=\"5\" text=\"Mask\" color=\"#ffffff\"/><Cell col=\"6\" colspan=\"2\" text=\"Radio\" color=\"#ffffff\"/><Cell col=\"8\" text=\"Edit\" color=\"#ffffff\"/><Cell col=\"9\" text=\"TextArea\" color=\"#ffffff\"/><Cell row=\"1\" text=\"Button\" displaytype=\"buttoncontrol\" edittype=\"button\"/><Cell row=\"1\" col=\"1\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell row=\"1\" col=\"2\" displaytype=\"combocontrol\" edittype=\"combo\" combodataset=\"dsCombo\" combocodecol=\"code\" combodatacol=\"data\"/><Cell row=\"1\" col=\"3\" displaytype=\"multicombocontrol\" edittype=\"multicombo\" multicombodataset=\"dsMCombo\" multicombocodecol=\"code\" multicombodatacol=\"data\"/><Cell row=\"1\" col=\"4\" displaytype=\"calendarcontrol\" edittype=\"date\" calendardateformat=\"yyyy-MM-dd\"/><Cell row=\"1\" col=\"5\" displaytype=\"maskeditcontrol\" edittype=\"mask\" maskeditformat=\"#,#.##\"/><Cell row=\"1\" col=\"6\" displaytype=\"radioitemcontrol\" edittype=\"radioitem\" radioitemcodevalue=\"1\" text=\"0\"/><Cell row=\"1\" col=\"7\"/><Cell row=\"1\" col=\"8\" displaytype=\"editcontrol\" edittype=\"text\"/><Cell row=\"1\" col=\"9\" displaytype=\"textareacontrol\" edittype=\"textarea\" textareascrolltype=\"vertical\" wordWrap=\"char\"/></Band><Band id=\"body\"><Cell text=\"bind:Column0\"/><Cell col=\"1\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:Column1\" calendardateformat=\"yyyy-MM-dd\" calendarbuttonsize=\"23\"/><Cell col=\"2\" displaytype=\"combocontrol\" edittype=\"combo\" text=\"bind:Column2\" combodataset=\"dsCombo\" combocodecol=\"code\" combodatacol=\"data\"/><Cell col=\"3\" displaytype=\"multicombocontrol\" edittype=\"multicombo\" text=\"bind:Column3\" multicombodataset=\"dsMCombo\" multicombodatacol=\"data\" multicombocodecol=\"code\"/><Cell col=\"4\" displaytype=\"calendarcontrol\" text=\"bind:Column4\" calendardateformat=\"yyyy-MM-dd\" edittype=\"date\"/><Cell col=\"5\" calendardateformat=\"yyyy-MM-dd\" text=\"bind:Column5\" maskeditformat=\"#,#.##\" displaytype=\"mask\"/><Cell col=\"6\" displaytype=\"radioitemcontrol\" text=\"bind:Column6\" edittype=\"radioitem\" radioitemcodevalue=\"1\"/><Cell col=\"7\"/><Cell col=\"8\" text=\"bind:Column7\" radioitemcodevalue=\"0\" displaytype=\"text\"/><Cell col=\"9\" radioitemcodevalue=\"1\" border=\"\\\" text=\"bind:Column8\" displaytype=\"text\" wordWrap=\"char\" textareascrolltype=\"vertical\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","Mobile_screen",440,1260,this,
            	//-- Layout function
            	function(p)
            	{
                var rootobj = p;
                ...
                p.Static02.move("20.00","581","130","30",null,null);
                ...
                p.Static03.move("20.00","868","117","30",null,null);
                ...
                p.Radio00.move("Static03:20.00","868","225","30",null,null);
                ...
                p.Static04.move("20.00","1058","102","30",null,null);
                ...
                p.rdoTreeStatus.move("Static02:20.00","581","225","30",null,null);
                ...
                p.Static01_00.move("20","323","203","30",null,null);
                ...
                p.Grid001.set_scrollbartype("autoindicator autoindicator");
                p.Grid001.set_autoenter("select");
                p.Grid001.move("20","Static01_00:5",null,"200","20",null);
            	}
            );
            ...
            obj = new Layout("large","Desktop_screen",920,1270,this,
                ...
                p.Static04.move("25.00","1062","345","30",null,null);
                ...
                p.Static02.move("30.00","580","424","30",null,null);
                ...
                p.Grid001.set_scrollbartype("autoindicator indicator");
        ...
        // User Script
        this.registerScript("renderer_org.xfdl", function() {
        ...
        this.Grid001_onheadvaluechanged = function(obj,e)
        {
        	...
        	else if (e.cell == 16 || e.cell == 17) //Radio
        	{
        		trace(e.cell);
        	}
        };
        ...
        this.loadIncludeScript("renderer_org.xfdl");
