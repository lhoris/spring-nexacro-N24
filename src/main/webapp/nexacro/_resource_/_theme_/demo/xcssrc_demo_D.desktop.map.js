            ...
            "Div" :
            						...
            						"div_WF_area" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"border" : nexacro.BorderObject("0px none transparent,0px none transparent,20px solid transparent")
            								}
            							}
            						}
            					},
            					{
            						"div_MLF_subMenu" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #343442,0px none")
            								}
            							}
            						}
            					},
            					...
            					},
            					{
            						"div_WF_component" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #515163"),
            									"color" : nexacro.ColorObject("#ffffff")
            								}
            							}
            						}
            					},
            					{
            						"div_WF_megaBg" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #3F415B")
            								}
            							}
            						}
            					},
            					...
            					},
            					{
            						"btn_TF_function01" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("url('imagerc::DarkMode/img_TF_function01.png')")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("url('imagerc::DarkMode/img_TF_function01_O.png')")
            								}
            							}
            						}
            					},
            					{
            						"btn_TF_function02" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("url('imagerc::DarkMode/img_TF_function02.png')")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("url('imagerc::DarkMode/img_TF_function02_O.png')")
            								}
            							}
            						}
            					},
            					{
            						"btn_TF_function02Dark" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("url('imagerc::DarkMode/img_TF_function02Dark.png')")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("url('imagerc::DarkMode/img_TF_function02Dark_O.png')")
            								}
            							}
            						}
            					},
            					{
            						"btn_TF_function03" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("url('imagerc::DarkMode/img_TF_function03.png')")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("url('imagerc::DarkMode/img_TF_function03_O.png')")
            								}
            							}
            						}
            					},
            					{
            						"btn_TF_function03ENG" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("url('imagerc::DarkMode/img_TF_function03E.png')")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("url('imagerc::DarkMode/img_TF_function03E_O.png')")
            								}
            							}
            						}
            					},
            					{
            						"btn_LF_Lmenu" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"font" : nexacro.FontObject("16px \"Noto Sans KR Medium\""),
            									"color" : nexacro.ColorObject("#FE5252")
            								},
            								"selected" :
            								{
            									"border" : nexacro.BorderObject("0px none,0px none,0px none,4px solid #6954E1"),
            									"font" : nexacro.FontObject("16px \"Noto Sans KR Medium\""),
            									"color" : nexacro.ColorObject("#FE5252")
            								}
            							}
            					...
            					},
            					{
            						"btn_BF_link" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"font" : nexacro.FontObject("17px \"Noto Sans KR Regular\""),
            									"color" : nexacro.ColorObject("#C5C9DF")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"color" : nexacro.ColorObject("#868BA7")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_MTF_prevBtn" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("url('imagerc::DarkMode/img_MTF_prevBtn.png')")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_MTF_menuBtn" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("url('imagerc::DarkMode/img_MTF_menuBtn.png')")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_MLF_homeBtn" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("url('imagerc::DarkMode/img_MLF_homeBtn.png')")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_MLF_closeMenu" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("url('imagerc::DarkMode/img_MLF_closeMenu.png')")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_MWF_closeDesc" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("url('imagerc::img_MWF_closeDesc.png')")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            								...
            								"pushed" :
            								{
            									"icon" : nexacro.UrlObject("url('imagerc::img_MWF_closeDesc_P.png')")
            								},
            								"selected" :
            								{
            									"icon" : nexacro.UrlObject("url('imagerc::img_MWF_closeDesc_P.png')")
            					...
            					},
            					{
            						"btn_TF_function02_M" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("url('imagerc::DarkMode/img_MTF_function02.png')")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_TF_function02Dark_M" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("url('imagerc::DarkMode/img_MTF_function02Dark.png')")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_TF_function03_M" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("url('imagerc::DarkMode/img_MTF_function03K.png') 35px 60px")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_TF_function03ENG_M" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("url('imagerc::DarkMode/img_MTF_function03E.png') 35px 60px")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            						...
            						"btn_MLF_Lmenu01" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"icon" : nexacro.UrlObject("url('imagerc::DarkMode/img_MLF_Lmenu01.png')"),
            									"color" : nexacro.ColorObject("#ffffff")
            								},
            								"focused" :
            								{
            						...
            						"btn_MLF_Lmenu02" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 20px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 20px"),
            									"icon" : nexacro.UrlObject("url('imagerc::DarkMode/img_MLF_Lmenu02.png')"),
            									"color" : nexacro.ColorObject("#ffffff")
            								},
            								"focused" :
            								{
            						...
            						"btn_MLF_Lmenu03" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 20px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 20px"),
            									"icon" : nexacro.UrlObject("url('imagerc::DarkMode/img_MLF_Lmenu03.png')"),
            									"color" : nexacro.ColorObject("#ffffff")
            								},
            								"focused" :
            								{
            						...
            						"btn_MLF_Lmenu04" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 20px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 20px"),
            									"icon" : nexacro.UrlObject("url('imagerc::DarkMode/img_MLF_Lmenu04.png')"),
            									"color" : nexacro.ColorObject("#ffffff")
            								},
            								"focused" :
            								{
            						...
            						"btn_MLF_Lmenu05" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"padding" : nexacro.PaddingObject("0px 0px 0px 20px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 20px"),
            									"icon" : nexacro.UrlObject("url('imagerc::DarkMode/img_MLF_Lmenu05.png')"),
            									"color" : nexacro.ColorObject("#ffffff")
            								},
            								"focused" :
            								{
            					...
            					},
            					{
            						"btn_WF_edtSearch" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("url('imagerc::DarkMode/img_WF_edtSearch.png')")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("url('imagerc::DarkMode/img_WF_edtSearch_O.png')")
            								},
            								"pushed" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_pagingFirst" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #484960")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("1px solid #484960")
            					...
            					},
            					{
            						"btn_pagingNum" :
            						{
            							"self" :
            							{
            								...
            								{
            									"color" : nexacro.ColorObject("#FFFFFF"),
            									"font" : nexacro.FontObject("bold 12px \"Arial\",\"Gulim\""),
            									"border" : nexacro.BorderObject("0px none")
            								},
            								"focused" :
            								{
            					...
            					},
            					{
            						"btn_WF_cal" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL('imagerc::DarkMode/btn_WF_Calendar.png')")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            				...
            				[
            					{
            						"sta_LF_menuTitle" :
            						{
            							"self" :
            							{
            								...
            								{
            									"padding" : nexacro.PaddingObject("0px 0px 0px 30px"),
            									"font" : nexacro.FontObject("20px \"Noto Sans KR Medium\""),
            									"color" : nexacro.ColorObject("#D7DAE2")
            								}
            							}
            						}
            					...
            					},
            					{
            						"sta_BF_copyright" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"font" : nexacro.FontObject("13px/20px \"Noto Sans KR Regular\""),
            									"color" : nexacro.ColorObject("#868BA7")
            								}
            							}
            						}
            					...
            					},
            					{
            						"sta_WF_pageTitle" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"font" : nexacro.FontObject("23px \"Noto Sans KR Bold\""),
            									"color" : nexacro.ColorObject("#A598EF")
            								}
            							}
            						}
            					},
            						...
            						"sta_WF_boxHead" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #515163"),
            									"color" : nexacro.ColorObject("#ffffff"),
            									"font" : nexacro.FontObject("18px \"Noto Sans KR Regular\""),
            									"padding" : nexacro.PaddingObject("0px 0px 0px 30px")
            								}
            							}
            						}
            					},
            					{
            						"sta_WF_txt14px" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"font" : nexacro.FontObject("14px/normal \"Noto Sans KR Regular\""),
            									"color" : nexacro.ColorObject("#ffffff")
            								}
            							}
            						}
            					...
            					},
            					{
            						"sta_WF_totalNum" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"font" : nexacro.FontObject("bold 14px \"Noto Sans KR Medium\""),
            									"color" : nexacro.ColorObject("#6954E1")
            								}
            							}
            						}
            					...
            					},
            					{
            						"sta_WF_fitTitle" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"color" : nexacro.ColorObject("#7E818F")
            								}
            							}
            						}
            					},
            			...
            			"Grid" :
            			{
            				"self" :
            				{
            					"enabled" :
            					{
            						"border" : nexacro.BorderObject("1px solid #4B4C5F")
            					}
            				},
            				"class" :
            				[
            											...
            											},
            											{
            												"grd_WF_check" :
            												{
            													"self" :
            													{
            														...
            														{
            															"color" : nexacro.ColorObject("#ffffff"),
            															"border" : nexacro.BorderObject("1px solid #66667a,0px none")
            														},
            														"selected" :
            														{
            															"color" : nexacro.ColorObject("#ffffff"),
            										...
            										"parent" :
            										{
            											"Grid" :
            											{
            												"self" :
            												{
            													"enabled" :
            													{
            														"border" : nexacro.BorderObject("1px solid #3F3285"),
            														"color" : nexacro.ColorObject("#ffffff"),
            														"font" : nexacro.FontObject("12px \"Noto Sans KR Regular\"")
            													},
            													"focused" :
            													...
            													"mouseover" :
            													{
            														"border" : nexacro.BorderObject("1px solid #322577")
            													}
            												}
            											}
            										}
            						...
            						"parent" :
            						{
            							...
            							"MultiComboListControl" :
            							{
            								"self" :
            								{
            									...
            									{
            										"icon" : nexacro.UrlObject("url('theme://images/chk_grd_Box.png')"),
            										"padding" : nexacro.PaddingObject("0px 0px 3px 9px"),
            										"color" : nexacro.ColorObject("#ffffff")
            									},
            									"mouseover" :
            									{
            			...
            			"VScrollBarControl" :
            			{
            				"self" :
            				{
            					"enabled" :
            					{
            						"border" : nexacro.BorderObject("1px solid #1E1D2B"),
            				...
            				"parent" :
            				{
            					"VScrollBarControl" :
            					{
            						"self" :
            						{
            							...
            							"pushed" :
            							{
            								"border" : nexacro.BorderObject("1px solid #6F7188")
            							},
            							"focused" :
            							{
            								"border" : nexacro.BorderObject("1px solid #6F7188")
            				...
            				[
            					{
            						"chk_WF_check16px" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"icon" : nexacro.UrlObject("URL('imagerc::chk_WF_Box16px.png')"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 8px"),
            									"color" : nexacro.ColorObject("#ffffff")
            								},
            								"mouseover" :
            								{
            									"icon" : nexacro.UrlObject("URL('imagerc::chk_WF_Box16px_O.png')")
            								},
            								"readonly" :
            								{
            									"icon" : nexacro.UrlObject("URL('imagerc::chk_WF_Box16px_D.png')")
            								},
            								"selected" :
            								{
            									"icon" : nexacro.UrlObject("URL('imagerc::chk_WF_Box16px_S.png')")
            								},
            								"disabled" :
            								{
            								...
            								{
            									"color" : nexacro.ColorObject("#dddddd"),
            									"icon" : nexacro.UrlObject("URL('imagerc::chk_WF_Box16px_DS.png')")
            								}
            							}
            						}
            					},
            			...
            			"Edit" :
            			{
            				"self" :
            				{
            					...
            					"readonly" :
            					{
            						"border" : nexacro.BorderObject("1px solid #575978")
            					},
            					"disabled" :
            					{
            						"border" : nexacro.BorderObject("1px solid #EEEFF3"),
            						"color" : nexacro.ColorObject("#6C6F8B")
            					},
            					"nulltext" :
            					{
            						"color" : nexacro.ColorObject("#6C6F8B")
            				...
            				[
            					{
            						"edit_WF_essential" :
            						{
            							"self" :
            							{
            								...
            								"readonly" :
            								{
            									"border" : nexacro.BorderObject("1px solid #FF9B9B")
            								},
            								"nulltext" :
            								{
            				...
            				"parent" :
            				{
            					"DateField" :
            					{
            						"self" :
            						{
            							...
            							"disabled" :
            							{
            								"border" : nexacro.BorderObject("1px solid #5F6180"),
            								"color" : nexacro.ColorObject("#76778A")
            							},
            							"readonly" :
            							{
            								"border" : nexacro.BorderObject("1px solid #5F6180"),
            								"color" : nexacro.ColorObject("#d5d5d5")
            							},
            							"invalid" :
            							{
            					...
            					"DateField" :
            					{
            						"self" :
            						{
            							"enabled" :
            							{
            								...
            								"color" : nexacro.ColorObject("#6E708B")
            							},
            							"invalid" :
            							{
            				...
            				"parent" :
            				{
            					"MultiComboListControl" :
            					{
            						"self" :
            						{
            							"enabled" :
            							{
            								"border" : nexacro.BorderObject("0px none, 0px none, 1px solid #53556e, 0px none"),
            								"icon" : nexacro.UrlObject("url('theme://images/chk_grd_Box.png')"),
            								"padding" : nexacro.PaddingObject("9px 0px 10px 9px"),
            								"color" : nexacro.ColorObject("#ffffff"),
            								"font" : nexacro.FontObject("12px \"Noto Sans KR Regular\"")
            							},
            							"mouseover" :
