if (!nexacro.NxPivot) {
	...
	*/	 
	nexacro.NxPivot = function (id, left, top, width, height, right, bottom, minwidth, maxwidth, minheight, maxheight, parent) {
		...
		this.addEvent("cancreate");
		this.addEvent("oncreate");
		this.addEvent("canrender");
		this.addEvent("onrender");
		this.addEvent("cantoolbarbuttonclick");
		this.addEvent("ontoolbarbuttonclick");
		this.addEvent("onerror");
		this.addEvent("ongridcellclick");
		this.addEvent("ongridcelldblclick");
		this.addEvent("ongridselectchanged");
	...
	nexacro.NxPivot.prototype = nexacro._createPrototype(nexacro.Div, nexacro.NxPivot);
	nexacro.NxPivot.prototype._type_name = "NxPivot";
	
	nexacro.NxPivot.prototype.configurationdata = null;	
				
	nexacro.NxPivot.prototype._contentsDef = 
	{
		"config":{
			"fields": [], "colAxis": [], "rowAxis": [], "values": [], "filters": []
		},
		"panel":{
			"toolbar": {
				"size": "28", "padding": "3 3 3 3", "gap": "2", "buttonsize": "20", "cssclass": "NxPivot_toolbarArea"
			},
			"items": {
				"size": "120",
				...
				"item": {
					"width": "150", "height": "25", "padding": "6 6 6 6", "gap": "4",
					...
					"sortsize": "16", "filtersize": "16", "aggregatorsize": "20", "buttonsize": "16"
				}
			}
		},
		"settingpopup":{
			"cssclass": "NxPivot_popup",
			"width": "230", "height": "250", "padding": "10 10 10 10",
			"buttonwidth": "50", "buttonheight": "25", "buttonalign": "center", 
	...
	nexacro.NxPivot.prototype.contentsDef = JSON.stringify(nexacro.NxPivot.prototype._contentsDef, null, "\t");
	
	nexacro.NxPivot.prototype.on_create_contents = function () {
	...
	nexacro.NxPivot.prototype.on_created_contents = function (win) {
	...
	nexacro.NxPivot.prototype.on_destroy_contents = function () {
	...
	nexacro.NxPivot.prototype.on_create_contents_command = function () {
		try{
			var str = "";
			return str;
		}finally{
	...
	nexacro.NxPivot.prototype.on_attach_contents_handle = function (win) {
		var form = this.form;
	...
	nexacro.NxPivot.prototype.onloadPivot = function() {
		try{
			if(NxPivotUtil.isEmpty(this.configurationdata)) {
				this.configurationdata = JSON.parse(this.contentsDef);
			}
	...
	nexacro.NxPivot.prototype.setLoadingbar = function(objFunc, bChkRender){
	...
	nexacro.NxPivot.prototype.convertStringToFunction = function(config){
	...
	nexacro.NxPivot.prototype.convertStringToFunctionItems = function(items){
		try{
			var i;
			var aggregator;
	...
	nexacro.NxPivot.prototype.convertFunctionToStringItems = function(items){
		try{
			var i;
			var aggregator;
	...
	nexacro.NxPivot.prototype.convertStringToArrayItems = function(items){
		var i;
		var j;
		var values;
		var arrValues = [];
	...
	nexacro.NxPivot.prototype.updateToDataset = function () {
		if(this.pivot) this.pivot.updateToDataset();
	};
	
    nexacro.NxPivot.prototype.render = function () {
	...
	nexacro.NxPivot.prototype.redraw = function(){
		this.pivot.view.panel._redrawPanelByPivotProp();
	};
	
	nexacro.NxPivot.prototype.enableToolbarButtons = function(arr, v){
		this.pivot.view.panel._enableToolbarButtons(arr, v);
	};
	
	nexacro.NxPivot.prototype.getPivotGrid = function(){
		return this.pivot.view.targetGrid;
	};
	
	nexacro.NxPivot.prototype.setConfig = function(config, changeOrg){
	...
	nexacro.NxPivot.prototype.getConfig = function(){
		try{
			var orgConfig = null;
	...
	nexacro.NxPivot.prototype.setPanel = function(panel, changeOrg){
		var config = {};
	...
	nexacro.NxPivot.prototype.setPanelConfig = function(panelConfig){
		try{
			var panel;
			var configurationData = JSON.parse(this.contentsDef);
	...
	nexacro.NxPivot.prototype.setSettingPopupConfig = function(settingPopupConfig){
		try{
			var settingPopup;
			var configurationData = JSON.parse(this.contentsDef);
	...
	nexacro.NxPivot.prototype.getPanel = function(){
		try{
			var panel = {};
	...
	nexacro.NxPivot.prototype.setSettingPopup = function(settingpopup, changeOrg){
		var config = {};
		...
		{
			config.settingpopup = this.setSettingPopupConfig(NxPivotUtil.clone(settingpopup, true));
		}
		else if(typeof settingpopup === "string")
		{
			var settingpopupJson = JSON.parse(settingpopup);
			config.settingpopup = this.setSettingPopupConfig(NxPivotUtil.clone(settingpopupJson, true));
		}
	...
	nexacro.NxPivot.prototype.getSettingPopup = function(){
		try{
			var settingpopup = {};
	...
	nexacro.NxPivot.prototype.getSelectedPivotData = function(nRowIdx, nCellIdx, arrValues, sType){
		try{
	...
	nexacro.NxPivot.prototype.getSelectedPivotDetailData = function(nRowIdx, nCellIdx){
		try{
			var GridView = this.pivot.view.gridView;
	...
	nexacro.NxPivot.prototype.setBindDataset = function (obj) {		
	...
	nexacro.NxPivot.prototype.getBindDataset = function () {
		return this._binddataset;
	};
	
	nexacro.NxPivot.prototype.contents = "";
	nexacro.NxPivot.prototype.set_contents = function (v)
	{
		this.contents = v;
	...
	nexacro.NxPivot.prototype._setContents = function (str) {	
	...
	nexacro.NxPivot.prototype.coltotalposition = "none";
	nexacro.NxPivot.prototype.set_coltotalposition = function(v) {		
		try{
	...
	nexacro.NxPivot.prototype.rowtotalposition = "none";	
	nexacro.NxPivot.prototype.set_rowtotalposition = function(v) {
	...
	nexacro.NxPivot.prototype.colgrandtotalposition = "none";
	nexacro.NxPivot.prototype.set_colgrandtotalposition = function(v) {
	...
	nexacro.NxPivot.prototype.rowgrandtotalposition = "none";	
	nexacro.NxPivot.prototype.set_rowgrandtotalposition = function(v) {
	...
	nexacro.NxPivot.prototype.roundfractiondigit = 2;
	nexacro.NxPivot.prototype.set_roundfractiondigit = function(v) {
	...
	nexacro.NxPivot.prototype.casesensitive = false;
	nexacro.NxPivot.prototype.set_casesensitive = function(v) {
	...
	nexacro.NxPivot.prototype.totaltext = "";
	nexacro.NxPivot.prototype.set_totaltext = function(v) {
		if(NxPivotUtil.isEmpty(v)) {
			return;
		}
	...
	nexacro.NxPivot.prototype.grandtotaltext = "";	
	nexacro.NxPivot.prototype.set_grandtotaltext = function(v) {
	...
	nexacro.NxPivot.prototype.usetoolbar = true;	
	nexacro.NxPivot.prototype.set_usetoolbar = function(v) {
	...
	nexacro.NxPivot.prototype.useitems = true;	
	nexacro.NxPivot.prototype.set_useitems = function(v) {
	...
	nexacro.NxPivot.prototype.loadingimage = "";
	nexacro.NxPivot.prototype.set_loadingimage = function(v) {	
		
		this.loadingimage = v;
	};	
	
	nexacro.NxPivot.prototype.gridheadheight = 20;	
	nexacro.NxPivot.prototype.set_gridheadheight = function(v) {
	...
	nexacro.NxPivot.prototype.gridbodyheight = 20;	
	nexacro.NxPivot.prototype.set_gridbodyheight = function(v) {
	...
	nexacro.NxPivot.prototype.gridsummheight = 20;	
	nexacro.NxPivot.prototype.set_gridsummheight = function(v) {
	...
	nexacro.NxPivot.prototype.binddataset = null;
	nexacro.NxPivot.prototype._binddataset = null;	
	nexacro.NxPivot.prototype.set_binddataset = function (str) {
	...
	nexacro.NxPivot.prototype.reload = function () {
		//this.on_apply_url(true);
	};

	nexacro.NxPivot.prototype.on_fire_cancreate = function(obj){
		try{
	...
	nexacro.NxPivot.prototype.on_fire_oncreate = function(obj){
		try{
	...
	nexacro.NxPivot.prototype.on_fire_canrender = function(obj){
		try{
	...
	nexacro.NxPivot.prototype.on_fire_onrender = function(obj){
		try{
	...
	nexacro.NxPivot.prototype.on_fire_onerror = function(obj, errortype, errormsg, statuscode){
		try{
	...
	nexacro.NxPivot.prototype.on_fire_cantoolbarbuttonclick = function(obj, id, postvalue, prevalue){
		try{
	...
	nexacro.NxPivot.prototype.on_fire_ontoolbarbuttonclick = function(obj, id, postvalue, prevalue){
		try{
	...
	nexacro.NxPivot.prototype.on_fire_onsize = function (width, height) {
		try{
	...
	nexacro.NxPivot.prototype.on_fire_ongridcellclick = function(obj, evt){
	...
	nexacro.NxPivot.prototype.on_fire_ongridcelldblclick = function(obj, evt){
	...
	nexacro.NxPivot.prototype.on_fire_ongridselectchanged = function(obj, evt){
