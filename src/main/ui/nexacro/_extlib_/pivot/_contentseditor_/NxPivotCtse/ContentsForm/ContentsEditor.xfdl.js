(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.popDivAggregator.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this.divConfig.form
            obj = new Layout("default","",0,0,this.divConfig.form,function(p){});
            this.divConfig.form.addLayout(obj.name, obj);

            //-- Default Layout : this.divPanel
            obj = new Layout("default","",0,0,this.divPanel.form,function(p){});
            this.divPanel.form.addLayout(obj.name, obj);

            //-- Default Layout : this.divSettingPopup
            obj = new Layout("default","",0,0,this.divSettingPopup.form,function(p){});
            this.divSettingPopup.form.addLayout(obj.name, obj);

            //-- Default Layout : this.popDivAggregator.form
            obj = new Layout("default","",0,0,this.popDivAggregator.form,function(p){});
            this.popDivAggregator.form.addLayout(obj.name, obj);
